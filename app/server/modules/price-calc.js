...
request(produit, function (err, resp, body){
    if(!err && resp.statusCode == 200){
        ...
        {
         console.log('Dans Amazon');
         temp = $('b.priceLarge', '#actualPriceValue').text();
         temp = temp.substr(5);
         console.log('le prix est:' + temp);
...
exports.ScrapingAmazon = function(product)
{
	...
	*/
    ...
    //console.log('Email ScrapingAmazon' +email);
       if(temp < product.currentPrice) exports.yougotmail(email, temp, product.productName, 
       function(e,o){});
...
exports.ScrapingFutureShop = function(product)
{
    ...
    console.log('ScrapingFutureShop' + product);
...
exports.updateProductTracked = function()
{
   ...
   //pou chacune des entrees
    for(var i=0; i<o.length; i++)
    {
      ...
      if(o[i]) 
      {
     	if(o[i].website == 'Amazon') 
     		{
     		console.log('Amazon scraping');
     		exports.ScrapingAmazon(o[i]);
     
     		}
     else if(o[i].website == 'FutureShop')
     {	console.log('FS scraping');
     	exports.ScrapingFutureShop(o[i]);
     }
...
var mailOptions = {
    ...
    //TEMPORAIREMENT BYPASSE POUR PRODUCT;
       //TEMPORAIREMENT BYPASSE POUR PRODUCT;
          //TEMPORAIREMENT BYPASSE POUR PRODUCT;
             //TEMPORAIREMENT BYPASSE POUR PRODUCT; 
    text: "Le prix de l'article: " + product + " est maintenant à: " + nouveauPrix   // plaintext body
